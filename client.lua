...
local stations <const> = {
    ...
    { node = 388,  name = "LS Parking",    },
    { node = 434,  name = "LS Terminal 4", },
    { node = 530,  name = "LS Terminal 4", },
...
local defaultStationText <const> = "~BLIP_124~ hattındasınız, sonraki istasyon ~g~~a~"
